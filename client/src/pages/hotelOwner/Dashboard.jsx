...
const Dashboard = () => {
    ...
    const [dashdboardData, setDashboardData] = useState({
        bookings: [],
        totalBookings: 0,
        totalRevenue: 0,
    })
    ...
    const fetchDashBoardData = async () => {
        try {
            ...
            if (data.success) {
                setDashboardData(data.dashdboardData)
            } else {
            ...
            <div className="flex flex-col md:flex-row gap-6 my-8">
                ...
                <div className="flex items-center gap-4 bg-white p-6 rounded-xl shadow-md w-full md:w-1/2">
                    ...
                    <div>
                        ...
                        <p className="text-xl font-semibold text-gray-800">{currency}{dashdboardData.totalRevenue}</p>
                    </div>
                </div>
            </div>
